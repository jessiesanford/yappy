...
//
// import { YChange } from '../../../types/prosemirrorTypes';
// import { Node } from 'prosemirror-model';
//
// const calcYChangeStyle = (ychange: YChange) => {
//   switch (ychange.type) {
//     case 'removed':
...
// };
//
// const hoverWrapper = (ychange: YChange, elements: Array<any>) =>
//   ychange === null ? elements : [['span', { class: 'ychange-hover', style: `background-color:${ychange.color.dark}` }, ychange.user || 'Unknown'], ['span', ...elements]];
//
//
...
//   selectable: false,
//   isolating: true,
//   toDOM: (node: Node): DOMOutputSpec => ['div', {
//     id: node.attrs.id,
//     class: 'sequence',
...
//       for (const l in node.attrs.linked) {
//         const link = node.attrs.linked[l];
...
//
//   toDOM: (node: ProsemirrorNode): DOMOutputSpec => {
//     const linked_sequence = [];
//     if (node.attrs.linked && !_.isEmpty(node.attrs.linked)) {
//       const link = node.attrs.linked;
